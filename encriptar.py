...
def encriptar(cadena, desplazamiento):
    ...
    Solo se encriptan las letras, los números y los signos de puntuación
    se dejan sin afectar 
    """
    salida = ""
...
def encriptar_archivo(entrada, desplazamiento):
    """
    Encripta el archivo de entrada aplicando el desplzamiento indicado.
