def frecuencia_palabras_en_archivo(archivo_entrada, archivo_salida):
    """Analiza la frencuencua con que ocurren diferentes palabras en un archivo 
    de texto."""
    frecuencias = {}
    ...
    # La colección.items() de un diccionario son las tuplas (clave, valor)
    # lo conforman
    ...
    # Convertir la colección de tuplas ordenadas en diccioanrio
